      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="label-stamp text-[11px] text-on-surface-variant">
              Password
            </label>
            <button
              type="button"
        ...
        <button
          ...
          className="w-full gradient-cta text-on-primary font-semibold text-sm py-3.5 rounded-full shadow-float hover:opacity-90 transition-opacity disabled:opacity-60"
        >
